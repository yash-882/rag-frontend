      ...
      <div style={s.card}>
        ...
        {step === "init" ? (
          <>
            ...
            <button style={{ ...s.btn, opacity: loading ? 0.6 : 1 }} onClick={initSignUp} disabled={loading}>
          ...
          <>
            ...
            <button style={{ ...s.btn, opacity: loading ? 0.6 : 1 }} onClick={completeSignUp} disabled={loading}>
        ...
        <div style={{ textAlign: "center", marginTop: 16, fontSize: 12, color: c.hint }}>
          Already have an account? <button style={s.link} onClick={() => navigate("/login")}>Sign In</button>
        </div>
      </div>
    </div>
  );
