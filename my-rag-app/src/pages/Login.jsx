  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <button style={{ ...s.btn, opacity: loading || !email || !password ? 0.5 : 1 }} onClick={submit} disabled={loading || !email || !password}>
        ...
        <div style={{ textAlign: "center", marginTop: 16, fontSize: 12, color: c.hint }}>
          No account? <button disabled={loading} style={s.link} onClick={() => navigate("/signup")}>Create one</button>
        </div>
      </div>
    </div>
  );
