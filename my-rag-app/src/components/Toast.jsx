...
const TOAST_META = {
  ...
  error: { bg: "#2d1515", border: "#5c2020", text: "#EB7074", icon: (<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M4 4l8 8M12 4l-8 8" strokeLinecap="round"/></svg>) },
