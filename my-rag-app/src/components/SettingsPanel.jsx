...
export default function SettingsPanel({ user, onClose, onUserUpdate, onAccountDeleted, onOpenFiles }) {
  ...
  const formatMemberSince = (dateStr) => {
    if (!dateStr) return "—";
    // Format date as "Date Month Year", e.g. "01 January 2023"
    return new Date(dateStr).toLocaleDateString(undefined, { day: "2-digit", month: "long", year: "numeric" });
  };
        ...
        <div style={{ padding: "20px" }}>
          ...
          {section === "account" && (
            <>
              ...
              {accountInfoLoading ? (
              <div style={{ display: "flex", gap: 5, justifyContent: "center", alignItems: "center", padding: "16px 0" }}>
