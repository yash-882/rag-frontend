export function PdfIcon() {
  return (
    <svg width="26" height="30" viewBox="0 0 26 30" fill="none" style={{ flexShrink: 0 }}>
      <rect width="26" height="30" rx="4" fill="#3d1515" />
      <text x="3" y="20" fontSize="8" fontWeight="700" fill="#ff6b6b" fontFamily="monospace">PDF</text>
    </svg>
  );
}
...
export function UploadIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6">
      <path d="M8 10V3M5 6l3-3 3 3M3 13h10" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function KeyIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M8.5 9.5l5 5M11 12l1.5 1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function ChatBubbleIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M2 2h12v9H9l-3 3v-3H2z" strokeLinejoin="round" />
    </svg>
  );
}
